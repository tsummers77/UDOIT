...
*/
?>
<h2 class="content-title"><?= ucfirst($content_group->title); ?> <small> <b><?= count($content_group->items); ?><b> of <?= $content_group->amount; ?> have issues.</small> <span class="proc-time">process time: <?= $content_group->time; ?>s</span></h2>
